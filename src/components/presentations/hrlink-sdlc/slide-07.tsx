  ...
  return (
    <SlideLayout number={7} title="Результаты аналитики" eyebrow="ТЕКУЩИЙ ПРОЦЕСС">
      ...
      <p className="artifact-service-note">
        <strong>Служебные артефакты:</strong> контекст, решения, открытые вопросы, состояние работы, связи требований с задачами, отчёты ревью и уточнения глоссария.
      </p>
      <p className="artifact-learnings">
        Улучшение навыков · learnings: наши корректировки → выводы → правка инструкций по команде человека. Сама модель не переобучается.
      </p>
