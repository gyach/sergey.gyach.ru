...
export function Slide08() {
    return (<SlideLayout number={8} variant="content" title={<>
          ...
          <p className="lead small">
            ...
            аналитик показывает актуальную постановку. Мастер-данные — Git.
          </p>
          ...
          <SlideTail aside={<SdlcQuestionsLink />} next="Далее: за что отвечают аналитик, разработчик и QA.">
            <PresentationDetail title="Как создать и опубликовать документ" variant="stage">
                <dl>
                  ...
                  <dd>
                    ...
                    Файл должен быть в выбранной ветке Git.
                  </dd>
                  <dt>Навыки</dt>
                  <dd>
