    ...
    return (<SlideLayout number={3} variant="content" title={<>
          ...
          <div className="process-map">
            <article className="map-node">
              ...
              <p className="skill-label">hrl-explore · hrl-wtf · hrl-discovery</p>
          ...
          <SlideTail next="Далее: дискавери — от идеи к понятному запросу.">
            <PresentationDetail title="Как связаны этапы" variant="stage">
                ...
                <p>
                  Сквозной пример в рассказе условный: клиент просит уведомление
                  сотруднику, заказчик приносит запрос, а дальше мы выясняем
                  проблему, согласуем поведение, реализуем и проверяем результат.
                  Реальную задачу пример не описывает.
                </p>
                <p>
