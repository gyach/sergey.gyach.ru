...
/** Сохраняет счётчик исходной презентации без повторной инициализации. */
export function PresentationAnalytics() {
    return <Script id="yandex-metrika" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: yandexMetrikaScript }}/>;
}
