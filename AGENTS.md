...
### Презентации: только настольный вид

- Презентации, включая SDLC, рассчитаны на настольный просмотр и показ на холсте
  16:9 (1920×1080). Мобильная адаптация для них не требуется.
- Не разрабатывайте отдельные мобильные макеты презентаций и не выполняйте
  проверки презентаций на мобильных размерах окна.
- Проверяйте все слайды в настольном браузере, включая пояснения, навигацию,
  интерактивные состояния, читаемость и отсутствие пересечений или обрезания.
- Исключение относится только к презентациям. Требования к адаптивности и
  мобильным проверкам основного сайта сохраняются.
